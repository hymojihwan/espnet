...
class ESPnetASRKDTransducerModel(AbsESPnetModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        stats = dict(
            ...
            loss_kd=loss_kd.detach() if self.training else None,
    ...
    def extract_alignment(
        ...
        save_path = f"/home/user/Workspace/espnet/egs2/librispeech_100/asr1/exp/asr_conformer-rnnt-kd-streaming_raw_en_bpe2048_sp/kd_alignment.pdf"
        ...
        # argmax 경로를 점으로 시각화
        mask_np = true_label_probs.detach().cpu().numpy()
