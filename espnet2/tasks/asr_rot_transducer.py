...
from espnet2.asr_transducer.espnet_rot_transducer_model import ESPnetASRROTTransducerModel
...
class ASRTransducerTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetASRROTTransducerModel),
    ...
    @classmethod
    @typechecked
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRROTTransducerModel:
        """Required data depending on task mode.
        ...
        # 7. Build model
        model = ESPnetASRROTTransducerModel(
            ...
            prob_alignment_masking=args.prob_alignment_masking,
