...
from espnet2.asr_transducer.espnet_ota_transducer_model import ESPnetASRUOTATransducerModel
...
class ASRTransducerTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetASRUOTATransducerModel),
    ...
    @classmethod
    @typechecked
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRUOTATransducerModel:
        """Required data depending on task mode.
        ...
        # 7. Build model
        model = ESPnetASRUOTATransducerModel(
