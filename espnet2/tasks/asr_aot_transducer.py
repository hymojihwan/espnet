...
from espnet2.asr_transducer.espnet_aot_transducer_model import ESPnetASRAOTTransducerModel
...
class ASRTransducerTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetASRAOTTransducerModel),
    ...
    @classmethod
    @typechecked
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRAOTTransducerModel:
        """Required data depending on task mode.
        ...
        # 7. Build model
        model = ESPnetASRAOTTransducerModel(
