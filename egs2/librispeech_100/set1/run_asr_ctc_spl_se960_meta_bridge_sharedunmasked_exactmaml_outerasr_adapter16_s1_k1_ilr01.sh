...
./asr.sh \
    ...
    --asr_config conf/tuning/SPL/train_asr_ctc_spl_se960_meta_bridge_sharedunmasked_exactmaml_outerasr_adapter16_s1_k1_ilr01.yaml \
    ...
    --asr_tag asr_ctc_spl_se960_meta_bridge_sharedunmasked_exactmaml_outerasr_adapter16_s1_k1_ilr01_main \
    "$@"
