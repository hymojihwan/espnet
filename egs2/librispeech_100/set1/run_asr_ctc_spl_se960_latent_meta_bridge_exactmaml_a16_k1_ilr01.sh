...
./asr.sh \
    ...
    --asr_config conf/tuning/SPL/train_asr_ctc_spl_se960_latent_meta_bridge_exactmaml_a16_k1_ilr01.yaml \
    ...
    --asr_tag asr_ctc_spl_se960_latent_meta_bridge_exactmaml_a16_k1_ilr01_main \
    "$@"
