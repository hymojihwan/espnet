...
from espnet2.asr_transducer.espnet_otd_transducer_model import ESPnetASROTDTransducerModel
...
class ASRTransducerTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetASROTDTransducerModel),
    ...
    @classmethod
    @typechecked
    def build_model(cls, args: argparse.Namespace) -> ESPnetASROTDTransducerModel:
        """Required data depending on task mode.
        ...
        # 7. Build model
        model = ESPnetASROTDTransducerModel(
