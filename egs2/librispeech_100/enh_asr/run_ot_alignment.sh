...
# Uses Optimal Transport to align noisy features to enhanced features (instead of fusion)
train_set="train_clean_100"
valid_set="dev"
test_sets="test_clean test_other test_clean_noisy test_other_noisy"

enh_asr_task="enh_asr_transducer"
enh_asr_config=conf/tuning/enh_asr_transducer/conv_tasnet_ot_alignment.yaml
