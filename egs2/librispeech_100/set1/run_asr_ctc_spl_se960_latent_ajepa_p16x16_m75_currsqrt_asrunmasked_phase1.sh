...
./asr.sh \
    ...
    --asr_config conf/tuning/SPL/train_asr_ctc_spl_se960_latent_ajepa_p16x16_m75_currsqrt_asrunmasked_phase1.yaml \
    ...
    --asr_tag asr_ctc_spl_se960_latent_ajepa_p16x16_m75_currsqrt_asrunmasked_phase1_main_s0 \
    "$@"
