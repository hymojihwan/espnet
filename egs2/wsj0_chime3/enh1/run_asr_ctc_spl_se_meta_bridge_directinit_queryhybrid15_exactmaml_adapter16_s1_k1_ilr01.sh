...
../../TEMPLATE/asr1/asr.sh \
    ...
    --asr_task asr_jepa \
    --asr_config conf/new_SPL/CTC/train_asr_ctc_spl_se_meta_bridge_directinit_queryhybrid15_exactmaml_adapter16_s1_k1_ilr01.yaml \
    --inference_config conf/tuning/decode_ctc_bs1.yaml \
    --inference_asr_model valid.cer_ctc.ave_10best.pth \
    --asr_tag train_asr_ctc_spl_se_meta_bridge_directinit_queryhybrid15_exactmaml_adapter16_s1_k1_ilr01_wsj0_chime3_raw_bpe2048 \
