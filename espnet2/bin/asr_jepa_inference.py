...
def inference(
    ...
    loader = ASRJEPATask.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=ASRJEPATask.build_preprocess_fn(speech2text.asr_train_args, False),
        collate_fn=ASRJEPATask.build_collate_fn(speech2text.asr_train_args, False),
